...
//   pnpm run thelmabiotel-tblive:nodered:dev        -> edit a tracked scratch flow in tests/dev.flows.json
//   pnpm run thelmabiotel-tblive:nodered:examples   -> edit the SHIPPED example flow(s) in examples/
//
...
// The 1.0.1 datasheet's own detection example (receiver-1.0.1.pdf S8.2.1).
const SAMPLE = '$1000042,1589557202,615,S64K,1285,0,24,69,11\r'
...
const userDir = mkdtempSync(join(tmpdir(), 'nr-tblive-'))
