...
**✅ PREREQUISITES DONE (2026-07-28) — `protocol-core` + `nmea-parser@3.1.0`.** Everything norsub needs
from the base library is implemented, green and packed; norsub's own rewrite is the next step.
