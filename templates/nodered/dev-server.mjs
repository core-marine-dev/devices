...
// TODO: your node type (must match package.json node-red.nodes + parser.html) and a sample input
...
const starterFlow = (label) => JSON.stringify([
  ...
  { id: 'node', type: NODE_TYPE, z: 'tab', name: '', memory: true, x: 410, y: 140, wires: [['dbg']] },
